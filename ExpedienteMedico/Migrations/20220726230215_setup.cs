    ...
    public partial class setup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalHistoryMedicines", x => new { x.MedicalHistoryId, x.MedicineId });
                    table.ForeignKey(
                        name: "FK_MedicalHistoryMedicines_MedicalHistories_MedicalHistoryId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalHistoryMedicines_Physicians_PhysicianId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalHistorySufferings", x => new { x.MedicalHistoryId, x.SufferingId });
                    table.ForeignKey(
                        name: "FK_MedicalHistorySufferings_MedicalHistories_MedicalHistoryId",
                        column: x => x.MedicalHistoryId,
                        principalTable: "MedicalHistories",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalHistorySufferings_Physicians_PhysicianId",
                        column: x => x.PhysicianId,
                        principalTable: "Physicians",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalHistoryTreatments", x => new { x.MedicalHistoryId, x.TreatmentId });
                    table.ForeignKey(
                        name: "FK_MedicalHistoryTreatments_MedicalHistories_MedicalHistoryId",
                        column: x => x.MedicalHistoryId,
                        principalTable: "MedicalHistories",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalHistoryTreatments_Physicians_PhysicianId",
                        column: x => x.PhysicianId,
                        principalTable: "Physicians",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalImages_MedicalHistories_MedicalHistoryId",
                        column: x => x.MedicalHistoryId,
                        principalTable: "MedicalHistories",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalNotes_MedicalHistories_MedicalHistoryId",
                        column: x => x.MedicalHistoryId,
                        principalTable: "MedicalHistories",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalHistoryMedicines_PhysicianId",
                table: "MedicalHistoryMedicines",
                column: "PhysicianId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalHistorySufferings_PhysicianId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalHistoryTreatments_PhysicianId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalImages_MedicalHistoryId",
                table: "MedicalImages",
