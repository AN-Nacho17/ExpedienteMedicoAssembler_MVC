...
namespace ExpedienteMedico.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            if (!_roleManager.RoleExistsAsync(Roles.Role_Admin).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(Roles.Role_Physician)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(Roles.Role_Patient)).GetAwaiter().GetResult();
            }
